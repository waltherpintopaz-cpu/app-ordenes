...
export default function InventarioCatalogoPanel({ cardStyle, sectionTitleStyle }) {
  ...
  // Clave por Tipo+Modelo (sin Empresa) — el mismo modelo físico a veces queda
  // etiquetado con distinta empresa por inconsistencias de datos, y no debe duplicar precio.
  ...
  // Modelos únicos para config — precio efectivo (local > DB). Agrupado por Tipo+Modelo,
  // sin Empresa, para no duplicar el mismo modelo físico bajo distintas etiquetas de empresa.
