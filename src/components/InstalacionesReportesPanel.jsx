    ...
    try {
      const res = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: "system",
            content: "Eres analista de operaciones de una empresa ISP. Analiza las estadísticas de instalaciones de internet y genera un informe ejecutivo en español con formato markdown: ### para secciones, ** para negritas, - para viñetas. Destaca: nodos con más/menos éxito, gestoras con mayor volumen, tasas de cancelación y recomendaciones. Sé directo."
          }, {
            role: "user",
          ...
          <div style={{ ...cardStyle }}>
            ...
            {analisisIA ? (
              ...
              <div style={{ background: "#f8fafc", border: "1px dashed #cbd5e1", borderRadius: 10, padding: "32px 20px", textAlign: "center", color: "#94a3b8", fontSize: 13 }}>
                Haz clic en "🤖 Generar Análisis" para análisis de instalaciones por nodo, gestora y tendencias del período.
              </div>
            )}
          </div>
        </>
